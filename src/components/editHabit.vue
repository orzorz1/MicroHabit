		...
		<view v-if="editingHabit" class="createHabit">
			...
			<view class="stepsBox">
				...
				<view class="steps1">
					...
					<input class="input_habit"  v-model="Info.name" maxlength="10" :disabled='disableInput' />
				</view>
				<!-- 习惯每阶段的内容 -->
				<view v-for="(step,index) in Info.steps">
					<view class="steps1">
						...
						<view class="contentAndTime">
								<input class="input_stepContent" placeholder="完成内容" maxlength="14" v-model="Info.steps[index].content" :disabled='disableInput' />
