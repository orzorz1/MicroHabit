		...
		<view class="login-form">
			<form @submit="formSubmit">
				<view class="form-input">
					<input type="text" value="" placeholder="用户名" v-model="username" maxlength="10"/>
				</view>
				<view class="form-input">
					<input type="password" value="" placeholder="密码" v-model="password" @focus="passwordF_B" @blur="passwordF_B" maxlength="16"/>
				</view>
				<button type="primary" form-type="submit">登录</button>
				<view style="display: flex; justify-content: center;">
					<view class="regist" @tap="goRegist">注册</view>
				</view>
			</form>
		</view>
	</view>
